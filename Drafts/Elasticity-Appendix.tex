...
\begin{figure}[!htb]
\begin{center}
\caption{Aggregate value-added markup under different capital cost assumptions}
\label{FIG_markupva}
\includegraphics[width=1.0\textwidth]{fig_cap_markupva_comparison.eps}
\end{center}
\vspace{-.5cm}\singlespacing {\footnotesize \textbf{Notes}: This shows the time series of $\mu_t^{VA}$, the aggregate value-added markup, under three different assumptions on capital costs: no-profits (by construction the markup is one), investment costs, and depreciation costs. These series are based on the baseline estimates, including all industries. 
}
\end{figure}

\begin{figure}[!htb]
\begin{center}
\caption{Profits as a share of value-added under different capital cost assumptions}
\label{FIG_profitshare}
\includegraphics[width=1.0\textwidth]{fig_cap_profitsva_comparison.eps}
\end{center}
\vspace{-.5cm}\singlespacing {\footnotesize \textbf{Notes}: This shows the time series of $\pi_t^{VA}$, the aggregate value-added markup, under three different assumptions on capital costs: no-profits (by construction the markup is one), investment costs, and depreciation costs. These series are based on the baseline estimates, including all industries. 
}
\end{figure}
