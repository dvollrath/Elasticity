/*
Calculate ratios of Comp/VA for NAICS industries 47-62 to match I/O tables
*/
...
drop if naics4762code=="" // drop if matched, but no mapping to naics

// only keep years matching the I/O table
keep if inrange(year,1947,1962)
...
collapse (sum) indcomp indgo indgos indproinc indtxpi indva indftpt indfte ///
	(first) naics4762text, by(naics4762code year) 
move naics4762text naics4762code  // clean-up
...
save "./Work/USA_naics4762_comp_ratios.dta", replace 
