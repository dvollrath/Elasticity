/*
Calculate ratios of Comp/VA for NAICS industries 87-96 to match I/O tables
*/

// create working copy of sic87-naics mapping for matching
insheet using "./CSV/USA_sic87_naics_map.csv", clear names comma
save "./Work/USA_sic87_naics_map.dta", replace

// pull in sic72/year observations on VA, compensation, etc..
insheet using "./CSV/USA_sic8797_va.csv", clear names comma
save "./Work/USA_sic8797_va.dta", replace

joinby sic87text using "./Work/USA_sic87_naics_map.dta" // merge sic-to-naics matches
...
keep if inrange(year,1987,1996)
...
save "./Work/USA_naics8796_comp_ratios.dta", replace 
