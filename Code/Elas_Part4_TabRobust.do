...
file open f_result1 using "./Drafts/tab_tr_summary1.txt", write replace
capture file close f_result2
file open f_result2 using "./Drafts/tab_tr_summary2.txt", write replace

	use "./Work/USA_scenario_robust_results_all.dta", clear
